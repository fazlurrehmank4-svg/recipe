    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {favorites.length > 0 && (
          <div className="relative max-w-xs w-full">
            ...
            <input
              ...
              className="w-full ltr:pl-9 ltr:pr-3 rtl:pr-9 rtl:pl-3 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-rose-500/50"
            />
          </div>
        )}
      </div>
      ...
      {favorites.length === 0 ? (
        <div className="text-center py-20 bg-white dark:bg-slate-900 rounded-3xl border border-dashed border-slate-200 dark:border-slate-800 my-4 shadow-sm">
          ...
          <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">{t.noFavoritesTitle}</h3>
        ...
        <div className="text-center py-12 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800">
          <p className="text-sm text-slate-500">{t.noResultsTitle}</p>
        </div>
      ) : (
        /* Favorites Grid */
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredFavorites.map((dish) => (
            ...
            >
              ...
              <div className="relative h-56 w-full bg-slate-100 dark:bg-slate-800">
                ...
                <div className="absolute top-4 ltr:left-4 rtl:right-4 flex items-center gap-2">
                ...
                <button
                  ...
                  className="absolute top-4 ltr:right-4 rtl:left-4 p-2.5 rounded-full bg-rose-500 text-white shadow-lg hover:bg-rose-600 transition z-10"
